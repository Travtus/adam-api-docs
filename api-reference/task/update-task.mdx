...
<ParamField body="status" type="enum" default="none">
    ...
    Possible value: `created`, `in_progress`, `completed`, `deleted`
</ParamField>

<ParamField body="due_datetime" type="datetime" default="none">
    The due date of a task. Example: 2023-01-01T00:00:00
</ParamField>
...
<ParamField body="completed_datetime" type="string" default="none">
    The completed date of a task. Example: 2023-01-01T00:00:00
</ParamField>

<ParamField body="importance" type="enum" default="none">
    The importance of a task. Possible value: `low`, `normal`, `high`, `very_high`.
</ParamField>
...
<ParamField body="resident_id" type="string" default="none">
    The identifier of a resident that a task is targeted for. You can use this field to update the task resident.
</ParamField>
