...
{
   "error": {
    "type": "multiple_tenants_matched",
    "message": "Multiple tenant records identified for one of the tenant objects you have provided. Please provide more information so a single tenant record can be identified."
  }
}
```
