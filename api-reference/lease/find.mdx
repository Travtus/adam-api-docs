...
<ResponseField name="leases" type="string">
  ...
  <Expandable title="leases">
    ...
    <ResponseField name="tenant_external_refs" type="[string]" default="none">
      A list of tenant external references for the tenants associated with the retrieved lease.
    </ResponseField>
