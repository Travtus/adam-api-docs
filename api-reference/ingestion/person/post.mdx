...
It attempts to match the person information provided with existing records, within the scope of the portfolio IDs provided in the `portfolios` body parameter.

If no match is found, a new person record will be created and automatically scoped to the portfolios with the provided IDs. 
...
<ParamField body="portfolios" type="[string]" default="none">
  ...
  - setting portfolio assignment for a newly created person record
</ParamField>
