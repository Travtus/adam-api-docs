...
A portfolio must be provided for updating or creating the units.
...
<ParamField body="units" type="[object]" default="none" required>
  ...
  <Expandable title="unit">
    <ParamField body="identifier" type="string" default="none">
      ...
      If this matches a unit in the portfolios you have specified that unit will be updated, otherwise a new one will be created.
