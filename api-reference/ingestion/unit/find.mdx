...
Optionally, you can also pass in a list of portfolio IDs to filter the returned units down.
...
```json No unit records found for the provided parametersNo identifier or external reference query param provided
{
   "error": {
    "type": "not_found",
