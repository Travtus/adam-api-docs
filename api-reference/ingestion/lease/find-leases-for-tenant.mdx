...
description: "This endpoint leases for a specific tenant based on provided parameters."
---
...
Active leases are understood to have an end date in the future and a start date in the past relative to the current date.
...
Returned if neither of the tenant parameters are provided in the request body
