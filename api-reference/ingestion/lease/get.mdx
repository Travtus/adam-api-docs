---
title: "Get Lease"
api: "POST https://api.travtus.com/leases/"
description: "This endpoint returns information about one lease based on the provided parameters."
---

You need to provide exact matches in the body of the request for the attributes of the lease you are looking for.

Please note that all date fields included in the body parameters need to be specified as [ISO8601-formatted date string] (https://en.wikipedia.org/wiki/ISO_8601).
...
Returned if a lease record could not be found.
```json No lease record found for the provided parameters
{
   "error": {
    "type": "not_found",
    "message": "There is no lease record matching the provided parameters."
  }
}
