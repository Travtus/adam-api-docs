...
- It also feeds our **scoring models** which provide a normalized ranking across all your customers and communities to enable you to identify where to focus. More about that [<u>here</u>](https://app.intercom.com/a/apps/dqu8pwlk/articles/articles/9172825/show).
