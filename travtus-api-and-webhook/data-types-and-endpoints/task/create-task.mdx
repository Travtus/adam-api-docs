---
title: "Create Task"
api: "POST https://api.travtus.com/task/"
...
<ParamField body="priority_score" type="number" default="none">
    The priority score of the task.
</ParamField>

<ParamField body="queue_name" type="string" default="none">
    The name of the queue the task should be assigned to.
</ParamField>

<ParamField body="onsite_indicator" type="enum" default="none">
    Whether the task is onsite or not. Possible value: `onsite`, `not_onsite`.
</ParamField>

<ParamField body="topic" type="string" default="none">
    The tasks's topic.
</ParamField>

<ParamField body="user_goal" type="string" default="none">
    What the user hopes to achieve if the task is completed.
</ParamField>

<ParamField body="escalation_flag" type="boolean" default="none">
    Whether the task should be escalated or not.
</ParamField>
