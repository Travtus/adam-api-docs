...
Note: The primary recording should be provided in `call_transcript.recording_url`. Use `attachment_urls` only for additional, non‑recording files (do not duplicate the recording URL there).
