...
<img
  src="/help-center-migration/images/connecting-data-sources-benefits.png"
  alt="Benefits of connecting each data source across Gateway, scoring, Smart search, and Weekly reports"
  noZoom
