...
- **Messages**: on this button you can see the number of messages received in the time period you've selected in the date filter (default is the last week). Clicking it will take you to an area where you can further interrogate the different categories of message and themes seen. Check out [<u>this article</u>](https://intercom.help/travtus-d83752c4176c/en/articles/9173000-exploring-your-data) for more information.
