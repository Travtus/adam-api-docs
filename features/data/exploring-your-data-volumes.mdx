...
If you are interested in seeing the **content of the data** and themes within this (such as top resident goals), you can use the menu in the top right and navigate to **Insights \> Top Customer Goal**. Check out [<u>this article</u>](https://help.travtus.com/en/articles/9220756-exploring-your-data-content) for more information.
