...
- **mountPoint**: `string` (optional)
  A CSS selector for the host-page element the Gateway launcher should anchor to. Leave empty to pin the launcher to the viewport's top-right. Any valid CSS selector is accepted.

- **trigger**: `string` (optional)
  A CSS selector for an additional host-page element that opens the Gateway using the same launcher behavior. Use this if you want an existing button or link on your page to also open the Gateway. Any valid CSS selector is accepted.
...
const config = {
  ...
  mountPoint: "#gateway-anchor",
  trigger: "#open-gateway-button"
};
